...
其实最早“晦溟”是我兽设的名字。如你所见，我是一名福瑞控，而我得到了每位福瑞控的终极梦想：兽化，并且变成自己的兽设。

我以为我能从连画稿都约不起的穷逼一跃成为拥有世界上最真实兽装的福瑞大佬，可是现实好像和我想的不太一样……那也许是我兽生中最黑暗的一段时光。
...
小说主题使用的 Markdown 格式，因为可以使用 YAML 来加上元信息（标题和日期）而且……好吧，就等有心人发现些什么东西了。
